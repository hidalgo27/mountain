                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="section-title-1 tx-center os-animation" data-os-animation="fadeInUp" data-os-animation-delay="0s">
                                <?php
                                    echo '
                                        ...
                                        <h6 class="color-blue">'.$registro["duracion"].' DIAS / Preguntar Precio</h6>
                                    ';
                                ?>
                        ...
                        <div class="row text-center">
                            <div id="cd-intro-tagline">
                                <a href="#content-area-3" class="cd-btn">Preguntar Ahora</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="search-result">
                                ...
                                <ul class="row">
                                    <?php
                                        ...
                                        while ($listado = $ejecutar_consulta->fetch_assoc()) {
                                            echo '
                                                <li><b>DIA '.$listado["dia"].':</b> '.ucwords(strtolower($listado["titulo"])).' </li>
                                            ';
                                        }
                                    ?>
                                </ul>
                                <h3 class="text-16"><b>Incluye</b></h3>
                                <?php
                                    echo $registro["incluye"];
                                ?>
                                <h3 class="text-16"><b>No Incluye</b></h3>
                                <?php
                        ...
                        <div class="row" id="itinerary">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    while ($listado = $ejecutar_consulta->fetch_assoc()) {
                                        echo '
                                            <h3 class="text-16"><b>DIA '.$listado["dia"].':</b> '.$listado["titulo"].'</h3>
                        ...
                        <div class="row" id="destinations">
                            ...
                            <div class="row">
                                <?php
                                    $consulta = "SELECT tdestinos.nombre, tdestinos.imagen2 FROM tpaquetesdestinos
                                    LEFT JOIN tdestinos
                                        ...
                                        echo '
                                            <div class="col-lg-6">
                                                <div class="box-relative">
                                                    <a href="http://www.mountaincuscotours.com/es/viajes-peru/'.strtolower(str_replace(' ','-',$destinos["nombre"])).'/">
                                                        <img src="../../img/destinos/'.$destinos["imagen2"].'" alt="'.$destinos["nombre"].'">
                        ...
                        <div class="search-result">
                            ...
                            <ul class="row text-18">
                                <?php
                                    ...
                                    while ($listado = $ejecutar_consulta->fetch_assoc()) {
                                        echo '
                                            <li><a href="../'.str_replace(' ','-', strtolower($listado["titulo"])).'-'.$listado["duracion"].'-dias-tours/"><i class="fa fa-chevron-right text-info"></i> '.ucfirst(strtolower($listado["titulo"])).'</li></a>
                                        ';
                                    }
                                ?>
                            </ul>
