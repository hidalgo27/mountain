<div class=" item padding-top-60 padding-bottom-50 bg-fixed" id="content-area-4">
                    ...
                    <?php
                        ...
                        while ($listado = $ejecutar_consulta->fetch_assoc()) {
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 text-center os-animation" data-os-animation="fadeInUp" data-os-animation-delay="0s">
                                <a href="http://mountaintourscusco.com/peru-tours/'.str_replace(' ','-', strtolower($listado["titulo"])).'-'.$listado["duracion"].'-dias-tours/">
                                    <div class="content-area-2 clearfix">
                                        <div class="content-area-figure-1">
                                            <img src="http://mountaintourscusco.com/img/paquetes/'.$listado["imagen"].'" alt="'.$listado["titulo"].'">
                                        </div>
                                        <div class=" col-md-12 ">
        ...
        <div class="padding-top-60" id="content-area-3">
            <div class="container">
                <div class="row">
                    <div class="section-title-1 tx-center margin-bottom-30 os-animation" data-os-animation="fadeInUp" data-os-animation-delay="0s">
                        <h3 class="color-white">Obtenga un cotización gratuita</h3>
   ...
   <!--====================== JAVA SCRIPTS =============================-->
    ...
    <script type="text/javascript" src="http://www.mountaintourscusco.com/es/js/jquery-1.11.1.min.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/jquery.js"></script><!-- jquery 1.11.2 -->
    <script src="http://www.mountaintourscusco.com/es/js/bootstrap.min.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/classie.js"></script>
    
    <script src="http://www.mountaintourscusco.com/es/mail/contact.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/jquery.countTo.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/jquery.waypoints.min.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/application.js"></script>   
    <script src="http://www.mountaintourscusco.com/es/js/owl.carousel.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/triger.js" type="text/javascript"></script>
    <script src="http://www.mountaintourscusco.com/es/js/viedolightbox/video.js"></script>

    <script src="http://www.mountaintourscusco.com/es/js/jquery.flexslider-min.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/bootstrap-datepicker.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/isotope.pkgd.min.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/theme.js"></script>
    <script src="http://www.mountaintourscusco.com/es/js/menu.js"></script>
