                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="section-title-1 tx-center margin-bottom-30 os-animation" data-os-animation="fadeInUp" data-os-animation-delay="0s">
                                ...
                                <h6 class="color-blue">Nuestra experiencia como agencia garantiza un servicio de calidad en traslados y tours en Cusco<br></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="search-result">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <h6>Traslados</h6>
                            <p>Nuestros servicios de traslados están basados en las necesidades del viajero durante su visita al Cusco, las rutas listadas a continuación son los traslados destacados actuales de nuestra agencia</p>
                            <table class="table">
                                <thead>
                                    <th>Origen</th>
                                    <th>Destino</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Hotel</td>
                                        <td>Estacion de Wanchaq Peru Rail</td>
                                    </tr>
                                    <tr>
                                        <td>Recojo Hotel</td>
                                        <td>Estacion Poroy</td>
                                    </tr>
                                    <tr>
                                        <td>Recojo Estacion Poroy</td>
                                        <td>Hotel</td>
                                    </tr>
                                    <tr>
                                        <td>Cusco</td>
                                        <td>Estacion Ollantaytambo / Pachar</td>
                                    </tr>
                                    <tr>
                                        <td>Recogo Estacion Ollantaytambo</td>
                                        <td>Pachar / Cusco</td>
                                    </tr>
                                    <tr>
                                        <td>Cusco</td>
                            ...
                            <h6>Servicios</h6>
                            <ul class="row">
                                <li><i class="fa fa-check text-info"></i> City Tours (Sacsayhuaman,Kenko,Pucapucara, Tambomachay)</li>
                                <li><i class="fa fa-check text-info"></i> Combinada (Catedral,Koricancha,Sacsayhuaman,Kenko,Pucapucara, Tambomachay )</li>
                                <li><i class="fa fa-check text-info"></i> Valle Sagrado (Pisaq, Ollantaytambo, Chinchero)</li>
                                <li><i class="fa fa-check text-info"></i> Valle Sur ( Tipon,Piquillacta, Andahuaylillas)</li>
                                <li><i class="fa fa-check text-info"></i> Maras, Moray , Salineras, Chinchero</li>
                            </ul>
                        </div>
                        <div class="col-lg-4">
                            <img src="../img/transportation-1.jpg" alt="transportation renauld">
                            <hr>
                            <img src="../img/transportation-2.jpg" alt="transportation auto">
                            <hr>
