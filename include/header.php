        ...
        <header class="header" id="header">
            <div class="social-top header-social">
                <div class="container">
                    ...
                    <div class="col-lg-6">
                        <h6 class="color-white margin-top-40"><i class="fa fa-phone"></i> Call Us: +51 951272936 | <b><i class="fa fa-whatsapp"></i></b> +51 987361601</h6>
                    </div>
                    <div class="col-lg-3">
                        <ul>
                            <!-- <li><a href="https://www.facebook.com/profile.php?id=100010995098255" target="_blank"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="nav-gral">
                <div class="container">
                    <nav>
                        <a href="/" class="text-center"><img src="http://www.mountaincuscotours.com/img/logo-mountain.png" alt="logo mountain tours cusco"></a>
                        <ul class="padding-top-35">
                            <li><a href="http://www.mountaincuscotours.com/peru-tours/">Peru Tours</a></li>
                            <li>
                                <a href="http://www.mountaincuscotours.com/travel-peru/">Peru Destinations</a>
                                <ul>
                                    <?php
                                        ...
                                        while ($lista = $ejecutar_consulta->fetch_assoc()) {
                                            echo '<li><a href="http://www.mountaincuscotours.com/travel-peru/'.strtolower(str_replace(' ','-',$lista["nombre"])).'/">'.ucwords(strtolower($lista["nombre"])).'</a></li>';
                                        }
                                    ?>
                                    
                                </ul>
                            </li>
                            <li><a href="http://www.mountaincuscotours.com/about-us/">About Us</a></li>
                            <li><a href="http://www.mountaincuscotours.com/only-transportation/">Only transportation</a></li>
                            <li><a href="#content-area-3">Contact</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
