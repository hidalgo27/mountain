                        ...
                        <div class="search-result">
                            ...
                            <ul class="row text-18">
                                <?php
                                    ...
                                    while ($listado = $ejecutar_consulta->fetch_assoc()) {
                                        echo '
                                            <li><a href="http://www.mountaincuscotours.com/peru-tours/'.str_replace(' ','-', strtolower($listado["titulo"])).'-'.$listado["duracion"].'-days-tours/"><i class="fa fa-chevron-right text-info"></i> '.ucfirst(strtolower($listado["titulo"])).'</li></a>
                                        ';
                                    }
                                ?>
                            </ul>
