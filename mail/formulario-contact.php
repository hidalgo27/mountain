<?php
	if ($_POST["last_txt"] == '' && $_POST["numphone_txt"] == '' && $_POST["first_txt"] == '' && $_POST["email2"] == '' && !empty($_POST['kaozastita']) && ($_POST['kaozastita']=='Iam')) {
                                                ...
                                                <tbody>
                                                      ...
                                                      <tr>
                                                            <td style="padding:0px 50px 0px 50px">
                                                                  ...
                                                                  <p>Este usuario envio un mensaje de la pagina de Mountain Cusco Tours del formulario contactenos.</p>
		...
		$mail->setFrom('info@mountaincuscotours.com', 'Mountain Cusco Tours');
		
		//Set who the message is to be sent to
		$mail->addAddress('info@mountaincuscotours.com', 'Mountain Cusco Tours');
